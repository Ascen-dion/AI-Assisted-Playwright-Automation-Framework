/**
 * generate-email-windows.js
 *
 * Generates a dark-theme HTML email report for the HP Windows App (WDIO) tests.
 ...
 * Optional:
 *   REPORT_TITLE  (default: "HP Windows App Tests")
 */
'use strict';
...
const REPORT_TITLE = process.env.REPORT_TITLE || 'HP Windows App Tests';
...
// Use the most recently written report-N-N.json from wdio-html-nice-reporter.
...
try {
  ...
  if (jsonFiles.length === 0) {
    throw new Error('No report-N-N.json files found in test-results/windows/html/');
  }

  // Use the most recently modified file (covers re-runs and multi-worker setups)
  ...
  // Metrics from the reporter's own counters (single run, not aggregated)
  if (report.metrics) {
  ...
  const walkSuite = (suite) => {
    for (const test of (suite.tests || [])) {
      ...
      // Extract any error message from events
...
<title>HP Windows App Test Report</title>
</head>
...
<table width="640" cellpadding="0" cellspacing="0" role="presentation"
  ...
  <tr><td style="background:${headerGrad};padding:32px 36px 28px;">
    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
      <tr>
        <td>
          <p style="margin:0 0 6px;font-size:11px;font-weight:600;letter-spacing:2px;color:${MUTED};text-transform:uppercase;">Windows App Automation</p>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" role="presentation"
      ...
      <tr>
        <td style="font-size:12px;color:${TEXT_DIM};line-height:1.8;">
          <strong style="color:${TEXT};">&#x1F4BB; Platform</strong>&nbsp;&nbsp;Windows (windows-latest)<br>
          <strong style="color:${TEXT};">&#x1F50D; App</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;HP myHP (AD2F1837.myHP_v10z8vjag6ke6!App)<br>
          <strong style="color:${TEXT};">&#x26A1; Driver</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Appium + WinAppDriver v1.2.1<br>
          <strong style="color:${TEXT};">&#x1F4E6; Suite</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;HP App Smoke Tests (6 TCs)<br>
  ...
  <tr><td style="padding:18px 36px;border-top:1px solid ${BORDER};text-align:center;">
    <p style="margin:0;font-size:11px;color:${MUTED};">
      Powered by AI-Assisted Test Automation Framework &middot; WDIO v9 + Appium + WinAppDriver<br>
