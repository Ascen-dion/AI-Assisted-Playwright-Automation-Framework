/**
 * Test Spec: CAP1-1 TS-007 TC-002
 * Verify Pipeline tab displays planning view
 */
...
test.describe('[UI] CAP1-1 TS-007: Verify Planning Views', { tag: ['@regression', '@capital-one'] }, () => {
  ...
  test('[CAP1-1 TS-007 TC-002] Verify Pipeline tab displays planning view', async ({ page }) => {
    ...
    // Step 4: Verify Pipeline content is displayed
    const isActive = await budgetPage.isTabActive('Pipeline');
