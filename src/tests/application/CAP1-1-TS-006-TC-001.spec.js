/**
 * Test Spec: CAP1-1 TS-006 TC-001
 * Verify Target Revenue tab displays budget input sheet
 */
...
test.describe('[UI] CAP1-1 TS-006: Verify Budget Input Sheets', { tag: ['@regression', '@capital-one'] }, () => {
  ...
  test('[CAP1-1 TS-006 TC-001] Verify Target Revenue tab displays budget input sheet', async ({ page }) => {
    ...
    // Step 3: Click Target Revenue tab
    await budgetPage.clickTab('Target Revenue');

    // Step 4: Verify Target Revenue content is displayed
