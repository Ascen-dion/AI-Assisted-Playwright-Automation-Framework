...
test.describe('[UI] Medtronic India Homepage', { tag: ['@smoke', '@medtronic'] }, () => {
  ...
  test('[C257] Test Case 1: Verify homepage loads and displays the hero CTA', async ({ page }) => {
  ...
  test('[C258] Test Case 2: Verify MEIC section heading is visible on homepage', async ({ page }) => {
  ...
  test('[C259] Test Case 3: Verify Healthcare Professionals section is visible', async ({ page }) => {
    // Assert — HCP section heading is visible
    const hcpVisible = await homePage.isHcpHeadingVisible();
    expect(hcpVisible).toBe(true);
  });

  test('[C260] Test Case 4: Verify Impact section is visible on homepage', async ({ page }) => {
  ...
  test('[C261] Test Case 5: Verify Careers section is visible on homepage', async ({ page }) => {
  ...
  test('[C262] Test Case 6: Verify footer sections are visible', async ({ page }) => {
  ...
  test('[C263] Test Case 7: Navigate to Our Company page via hero "See how" CTA', async ({ page }) => {
  ...
  test('[C264] Test Case 8: Navigate to MEIC page via "Learn more" CTA', async ({ page }) => {
  ...
  test('[C265] Test Case 9: Navigate to Careers page via "Join us" CTA', async ({ page }) => {
  ...
  test('[C289] Test Case 10: Verify Healthcare Professionals menu item is displayed in header', async ({ page }) => {
  ...
  test('[C290] Test Case 11: Verify Patients & Caregivers menu item is displayed in header', async ({ page }) => {
    // Assert — nav link is visible in the header navigation
    const isVisible = await homePage.isNavPatientsAndCaregiversVisible();
    expect(isVisible).toBe(true);
  });

  test('[C291] Test Case 12: Verify Our Company menu item is displayed in header', async ({ page }) => {
    // Assert — nav link is visible in the header navigation
    const isVisible = await homePage.isNavOurCompanyVisible();
    expect(isVisible).toBe(true);
  });

  test('[C292] Test Case 13: Verify Our Impact menu item is displayed in header', async ({ page }) => {
    // Assert — nav link is visible in the header navigation
    const isVisible = await homePage.isNavOurImpactVisible();
    expect(isVisible).toBe(true);
  });

  test('[C293] Test Case 14: Verify Careers section is displayed on the homepage', async ({ page }) => {
